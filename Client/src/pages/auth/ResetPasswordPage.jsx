...
function ResetPasswordPage() {
  ...
  const submit = async (event) => {
    ...
    const passwordIssue = passwordPolicyMessage(form.password);
    if (passwordIssue) {
