...
import { Activity, BadgeIndianRupee, BarChart3, CircleAlert, LoaderCircle, TrendingUp, UserRoundCheck, UsersRound } from "lucide-react";
...
function AdminAnalyticsPage() {
  ...
  const load = async () => {
    setError("");
    try { setData(await getPlatformAnalytics()); } catch (requestError) { setError(requestError.response?.data?.message || "Unable to load platform analytics."); }
  };
